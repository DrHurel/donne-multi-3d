...
class Vertex {
public:
  inline Vertex() : pos(Vec3Df(0.0, 0.0, 0.0)), normal(Vec3Df(0.0, 0.0, 1.0)) {}
  inline Vertex(const Vec3Df &pos) : pos(pos), normal(Vec3Df(0.0, 0.0, 1.0)) {}
  ...
  static void scaleToUnitBox(std::vector<Vertex> &vertices, Vec3Df &center,
